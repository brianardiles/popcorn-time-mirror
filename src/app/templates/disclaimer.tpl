...
<div class="disclaimer-state">
    <div class="disclaimer-content">
        ...
        <div class="disclaimer-text">
            ...
            <p>By using the 'POPCORN TIME' app you signify your agreement to (1) these terms and conditions (the 'Terms of Service').
                <br>
                <br>
            </p>
            ...
            <p>ALL MOVIES ARE NOT HOSTED ON ANY SERVER AND ARE STREAMED USING THE P2P BIT TORRENT PROTOCOL. ALL MOVIES ARE PULLED IN FROM OPEN PUBLIC APIS. BY WATCHING A MOVIE WITH THIS APPLICATION YOU MIGHT BE COMMITTING COPYRIGHT VIOLATIONS DEPENDING ON YOUR COUNTRY´S LAWS. WE DO NOT TAKE ANY RESPONSIBILITIES.
                <br>
                <br>
            </p>
