    ...
    <div class="content">
        ...
        <div class="issue-outer">
            <div id="issue-auth">
                <div class="report-info">
                    <%=i18n.__( "Log in into your GitLab account") %>
                        <a class="links" href="https://git.popcorntime.io/users/sign_in">
                ...
                <br>
                <div class="button login-issue">
                    <%=i18n.__( "Log in") %>
                </div>
                <div class="button anonymous-issue">
                    <%=i18n.__( "Report anonymously") %>
                </div>
                <p>
                    <%=i18n.__( "Note regarding anonymous reports:") %>
                        <br>
                        <span class="note"><%= i18n.__("You will not be able to edit or delete your report once sent.") %></span>
                        <br>
            ...
            <div id="issue-search">
                ...
                <div class="button found-issue">
                    <%=i18n.__( "Already reported") %>
                </div>
                <div class="button notfound-issue">
                    <%=i18n.__( "I want to report a new issue") %>
                </div>
            </div>
            <div id="issue-form">
                <div class="report-info">
                ...
                <p style="font-size: 12px">
                    <%=i18n.__( "200 characters minimum") %> <span id="issue-length">(0/200)</span></p>
            ...
            <div id="issue-success">
                ...
                <p>
                    <a href="#" class="links" id="issue-url"></a>
                </p>
            </div>
        </div>
    </div>
