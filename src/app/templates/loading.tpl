<div class="loading">
    ...
    <div class="state">
        <div class="title"></div>
        <div class="external-play" style="visibility:hidden">
            <%=i18n.__( "Streaming to") %> <span class="player-name"></span></div>
        <!-- download -->
        ...
        <div class="cancel-button">
            <div class="cancel-button-text">
                <%=i18n.__( "Cancel") %>
            </div>
        </div>
    </div>
    <div class="warning-nospace">
        <span class="warn"><%= i18n.__('Your disk is almost full.') %></span>
        <br>
